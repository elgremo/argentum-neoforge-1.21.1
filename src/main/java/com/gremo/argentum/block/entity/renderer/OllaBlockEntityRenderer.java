...
public class OllaBlockEntityRenderer implements BlockEntityRenderer<OllaBlockEntity> {
    public OllaBlockEntityRenderer(BlockEntityRendererProvider.Context context) {}

    @Override
    public void render(OllaBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
