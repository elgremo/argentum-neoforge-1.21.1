...
@OnlyIn(Dist.CLIENT)
public class CeiboParticles extends TextureSheetParticle {

    private float rotSpeed; // ❌ ¡Ya NO es final!
    private final float spinAcceleration; // Esta SÍ puede ser final

    protected CeiboParticles(ClientLevel level, double x, double y, double z, SpriteSet spriteSet) {
        super(level, x, y, z);
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            return new CeiboParticles(level, x, y, z, this.spriteSet);
        }
    }
}