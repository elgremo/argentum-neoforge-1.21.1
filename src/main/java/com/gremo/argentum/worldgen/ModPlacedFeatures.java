...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> VID_PATCH =
            ResourceKey.create(
                    ...
                    ResourceLocation.fromNamespaceAndPath(
                            Argentum.MOD_ID,
                            "vid_patch"));
    public static final ResourceKey<PlacedFeature> VID_BLANCA_PATCH =
            ResourceKey.create(
                    Registries.PLACED_FEATURE,
                    ResourceLocation.fromNamespaceAndPath(
                            Argentum.MOD_ID,
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        Holder<ConfiguredFeature<?, ?>> vid_blanca =
                context.lookup(Registries.CONFIGURED_FEATURE)
                        .getOrThrow(ModConfiguredFeatures.VID_BLANCA_PATCH);


        context.register(YERBA_PATCH,
                new PlacedFeature(
                        yerba,
                        List.of(
        ...
        context.register(MEMBRILLO_PATCH,
                new PlacedFeature(
                        membrillo,
                        List.of(
                                RarityFilter.onAverageOnceEvery(6),
        ...
        context.register(VID_BLANCA_PATCH,
                new PlacedFeature(
                        vid_blanca,
                        List.of(
                                RarityFilter.onAverageOnceEvery(1),
